 ...
 * @website
 * @Note 2nd Way : Reference to instance method from instance
 *
 */
public class SecondInstanceMethodsRef {
	...
	public static void main(String[] args) {
		...
		Greeting greeting = new SecondInstanceMethodsRef()::greetingMessage;
		greeting.greetingMessage();

		MaxNumberFinder maxFinder = new SecondInstanceMethodsRef()::findMax;
		System.out.println("findMax : " + maxFinder.findMax(23, 34));

		MinNumberFinder minFinder = new SecondInstanceMethodsRef()::findMin;
